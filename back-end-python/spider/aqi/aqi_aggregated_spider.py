...
def parse_args():
    parser = argparse.ArgumentParser(description="AQI 综合聚合源爬虫")
...
def main():
    ...
    inserted = crawl_by_source(args.city, start_date, end_date, "aqi_aggregated")
    print(f"aqi aggregated spider finished, inserted_or_updated={inserted}")
