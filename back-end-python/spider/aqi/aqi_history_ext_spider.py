...
def parse_args():
    parser = argparse.ArgumentParser(description="AQI 历史扩展源爬虫")
...
def main():
    ...
    inserted = crawl_by_source(args.city, start_date, end_date, "aqi_history_ext")
    print(f"aqi history ext spider finished, inserted_or_updated={inserted}")
