...
def parse_args():
    parser = argparse.ArgumentParser(description="AQI 实时补充源爬虫")
...
def main():
    ...
    inserted = crawl_by_source(args.city, start_date, end_date, "aqi_realtime")
    print(f"aqi realtime spider finished, inserted_or_updated={inserted}")
